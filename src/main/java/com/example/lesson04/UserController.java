...
public class UserController {
	...
	public String addUserView() {   // @ResponseBody가 없으면 view의 경로를 리턴한다.  
		return "lesson04/addUser";   // /WEB_INF/jsp/lesson04/addUser.jsp
	}
	...
	public String getLastUser(Model model) {
		...
		model.addAttribute("result", lastUser); // 결과 jsp view에 객체값을 넘겨준다.
