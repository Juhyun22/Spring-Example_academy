	...
	<div class="container">
		...
		<form method="post" action="/lesson04/ex01/add_user">
			...
			<div class="form-group">
				...
				<input type="text" id="yyyymmdd" name="yyyymmdd" class="form-control col-3" placeholder="예)19900405">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea id="introduce" name="introduce" class="form-control col-5" rows="10" placeholder="자기소개 작성"></textarea>
			</div>
