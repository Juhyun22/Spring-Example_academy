...
<body>
	<div class="container">
		<b>이름: </b>
		<div class="d-flex">
			<input type="text" class="form-control col-3" id="name" name="name" placeholder="이름을 입력해주세요.">
			...
			$.ajax({
				...
				, success : function(data) {
					...
					if (data.is_duplication == true) {
						$('#nameStatusArea').append('<span class="text-danger">이름이 중복되어있습니다.</span>');
					} else {
						$('#nameStatusArea').append('<span class="text-info">사용 가능한 이름입니다.</span>');
					}
				}
				, error : function(e) {
					alert("error : " + e);
